  ...
  <header class="header">
    <div class="header-group">
      <div class="flex items-center justify-between py-10">
        ...
        <div class="flex">
          <button
            class="px-6 py-2 font-bold rounded-full text-white focus:outlin"
          >
            Crie uma conta
          </button>
          <button
            class="px-6 py-2 font-bold bg-white rounded-full text-brand-main focus:outlin"
          >
            Entrar
          </button>
        </div>
      ...
      <div class="flex flex-col mt-28 space-y-2">
        ...
        <div>
          <button
            class="px-6 py-2 font-bold bg-white rounded-full text-brand-main focus:outlin mt-9"
          >
