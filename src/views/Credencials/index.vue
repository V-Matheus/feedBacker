<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      >
        <span v-if="state.hasErro">Erro ao carregar apikey</span>
        <span v-else>{{ store.User.currentUser.apiKey }}</span>
        <div class="flex ml-20 mr-5" v-if="!state.hasErro">
          <icon
            @click="handleCopy"
            name="copy"
      ...
      >
        <span v-if="state.hasErro">Erro ao carregar o script</span>
        <pre v-else>
&lt;script scr="https://V-Matheus-feedbacker-widget.netflify.app?apiKey={{
