  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      ...
      <button
        ...
        class="px-6 py-3 mt-10 text-2lx font-bold text-white rounded-full bg-brand-main focus:outline-none transition-all duration-150"
  ...
  setup() {
    ...
    async function handleSubmit() {
      try {
        ...
        const { erros } = await services.auth.register({
